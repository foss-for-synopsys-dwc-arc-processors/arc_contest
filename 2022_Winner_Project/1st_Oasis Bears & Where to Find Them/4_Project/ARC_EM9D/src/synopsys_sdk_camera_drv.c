...
int app_config_sensor_WE1_rx(uint8_t sensor_init_required, uint8_t sensor_strobe_req)
{
    ...
    if (sensordplib_set_sensorctrl_inp(app_cust_config.sensor_table_cfg.sensor_id, app_cust_config.sensor_table_cfg.sensor_stream_type, app_cust_config.sensor_table_cfg.sensor_width, app_cust_config.sensor_table_cfg.sensor_height, app_cust_config.we1_driver_cfg.subsample) != 0)
    {
