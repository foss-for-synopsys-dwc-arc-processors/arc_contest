...
// float tflitemicro_algo_run(uint8_t * ptr_image);
float tflitemicro_algo_run(float * ptr_image);
int tflitemicro_algo_init_2();
float tflitemicro_algo_run_2(float * ptr_image);
#ifdef __cplusplus
}
#endif
